    ...
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full
     ...
     {images.length>0 ? (
      <div className='flex flex-wrap max-sm:justify-center gap-5'>
        {images.map((item,index)=>(<a key={index} href={item.imageUrl} target='_blank' className='relative group block rounded-lg overflow-hidden border border-gray-200
          ...
          <p className='absolute bottom-0 right-0 text-sm bg-black/50 backdrop-blur text-white px-4 py-1 rounded-tl-xl opacity-0
