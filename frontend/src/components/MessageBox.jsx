...
const MessageBox=({message})=>{
  ...
  return (
    <div>
     ...
     :
     (
      <div className='inline-flex flex-col gap-2 p-2 px-2 max-w-2xl bg-primary/20
       dark:bg-[#57317C]/30 border border-[#80609F]/30  rounded-md my-4'>
        {message.isImage ? (
          <img src={message.content} alt="" className='w-full max-w-md rounded-md mt-2'/>
        ):
        (
          <div className='text-sm dark:text-primary reset-tw'>
           {/* The mardown package use for the format */}
           <Markdown>
             {message.content}
           </Markdown>
          </div>
